...
public class Main {
    public static void main(String[] args) {
        ...
        if (!(airplaneFoodMeat instanceof Vegetable)) { // Testing if airplaneFoodMeat is not an instance of Vegetable,
                                                        // it
                                                        // is not
        ...
        if (airplaneFoodMeat instanceof Meat) { // Checking if airplaneFoodMeat is an instance of Meat
            newAirplaneMeat = (Meat) airplaneFoodMeat; // Cast the Food object to a meat object because the superclass
                                                       // is able
        ...
        System.out.println(newAirplaneMeat instanceof Meat); // Prints out true, meaning we have casted the Food object
                                                             // to a
                                                             // Meat object
